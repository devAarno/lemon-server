...
static void test_strncasecmp(void) {
    ...
    TEST_ASSERT_EQUAL(LE_OK, appendHttpGetParameterQueryRequest(&request, "hello", (httpGetParameterQueryExecutionHandler) fakeExecute, &helloCallback1));

    helloCallback2.callCounter = 0;
    helloCallback2.expectedValue.data = "world";
    helloCallback2.expectedValue.length = 5;
    TEST_ASSERT_EQUAL(LE_OK, appendHttpGetParameterQueryRequest(&request, "HELLO", (httpGetParameterQueryExecutionHandler) fakeExecute, &helloCallback2));

    value1Callback1.callCounter = 0;
    value1Callback1.expectedValue = getEmptyString();
    TEST_ASSERT_EQUAL(LE_OK, appendHttpGetParameterQueryRequest(&request, "value1", (httpGetParameterQueryExecutionHandler) fakeExecute, &value1Callback1));

    value1Callback2.callCounter = 0;
    value1Callback2.expectedValue = getEmptyString();
    TEST_ASSERT_EQUAL(LE_OK, appendHttpGetParameterQueryRequest(&request, "vALuE1", (httpGetParameterQueryExecutionHandler) fakeExecute, &value1Callback2));

    value1Callback3.callCounter = 0;
    value1Callback3.expectedValue = getEmptyString();
    TEST_ASSERT_EQUAL(LE_OK, appendHttpGetParameterQueryRequest(&request, "VALUE1", (httpGetParameterQueryExecutionHandler) fakeExecute, &value1Callback3));

    value2Callback1.callCounter = 0;
    value2Callback1.expectedValue = getEmptyString();
    TEST_ASSERT_EQUAL(LE_OK, appendHttpGetParameterQueryRequest(&request, "value2", (httpGetParameterQueryExecutionHandler) fakeExecute, &value2Callback1));

    value2Callback2.callCounter = 0;
    value2Callback2.expectedValue = getEmptyString();
    TEST_ASSERT_EQUAL(LE_OK, appendHttpGetParameterQueryRequest(&request, "VALue2", (httpGetParameterQueryExecutionHandler) fakeExecute, &value2Callback2));

    value2Callback3.callCounter = 0;
    value2Callback3.expectedValue = getEmptyString();
    TEST_ASSERT_EQUAL(LE_OK, appendHttpGetParameterQueryRequest(&request, "valUE2", (httpGetParameterQueryExecutionHandler) fakeExecute, &value2Callback3));

    testCallback1.callCounter = 0;
    testCallback1.expectedValue.data = "test";
    testCallback1.expectedValue.length = 4;
    TEST_ASSERT_EQUAL(LE_OK, appendHttpGetParameterQueryRequest(&request, "test", (httpGetParameterQueryExecutionHandler) fakeExecute, &testCallback1));

    testCallback2.callCounter = 0;
    testCallback2.expectedValue.data = "test";
    testCallback2.expectedValue.length = 4;
    TEST_ASSERT_EQUAL(LE_OK, appendHttpGetParameterQueryRequest(&request, "tESt", (httpGetParameterQueryExecutionHandler) fakeExecute, &testCallback2));

    testCallback3.callCounter = 0;
    testCallback3.expectedValue.data = "test";
    testCallback3.expectedValue.length = 4;
    TEST_ASSERT_EQUAL(LE_OK, appendHttpGetParameterQueryRequest(&request, "TesT", (httpGetParameterQueryExecutionHandler) fakeExecute, &testCallback3));

    yesCallback1.callCounter = 0;
    yesCallback1.expectedValue = getEmptyString();
    TEST_ASSERT_EQUAL(LE_OK, appendHttpGetParameterQueryRequest(&request, "yes", (httpGetParameterQueryExecutionHandler) fakeExecute, &yesCallback1));

    yesCallback2.callCounter = 0;
    yesCallback2.expectedValue = getEmptyString();
    TEST_ASSERT_EQUAL(LE_OK, appendHttpGetParameterQueryRequest(&request, "yeS", (httpGetParameterQueryExecutionHandler) fakeExecute, &yesCallback2));

    yesCallback3.callCounter = 0;
    yesCallback3.expectedValue = getEmptyString();
    TEST_ASSERT_EQUAL(LE_OK, appendHttpGetParameterQueryRequest(&request, "yEs", (httpGetParameterQueryExecutionHandler) fakeExecute, &yesCallback3));

    clientCallback1.callCounter = 0;
    clientCallback1.expectedValue = getEmptyString();
    TEST_ASSERT_EQUAL(LE_OK, appendHttpHeaderQueryRequest(&request, "Client", (httpHeaderQueryExecutionHandler) fakeExecute, &clientCallback1));

    clientCallback2.callCounter = 0;
    clientCallback2.expectedValue = getEmptyString();
    TEST_ASSERT_EQUAL(LE_OK, appendHttpHeaderQueryRequest(&request, "ClieNT", (httpHeaderQueryExecutionHandler) fakeExecute, &clientCallback2));

    clientCallback3.callCounter = 0;
    clientCallback3.expectedValue = getEmptyString();
    TEST_ASSERT_EQUAL(LE_OK, appendHttpHeaderQueryRequest(&request, "ClIEnT", (httpHeaderQueryExecutionHandler) fakeExecute, &clientCallback3));

    serverCallback1.callCounter = 0;
    serverCallback1.expectedValue = getEmptyString();
    TEST_ASSERT_EQUAL(LE_OK, appendHttpHeaderQueryRequest(&request, "Server", (httpHeaderQueryExecutionHandler) fakeExecute, &serverCallback1));

    serverCallback2.callCounter = 0;
    serverCallback2.expectedValue = getEmptyString();
    TEST_ASSERT_EQUAL(LE_OK, appendHttpHeaderQueryRequest(&request, "SerVER", (httpHeaderQueryExecutionHandler) fakeExecute, &serverCallback2));

    serverCallback3.callCounter = 0;
    serverCallback3.expectedValue = getEmptyString();
    TEST_ASSERT_EQUAL(LE_OK, appendHttpHeaderQueryRequest(&request, "SERVER", (httpHeaderQueryExecutionHandler) fakeExecute, &serverCallback3));

    thisCallback1.callCounter = 0;
    thisCallback1.expectedValue.data = "is a value";
    thisCallback1.expectedValue.length = 10;
    TEST_ASSERT_EQUAL(LE_OK, appendHttpHeaderQueryRequest(&request, "this", (httpHeaderQueryExecutionHandler) fakeExecute, &thisCallback1));

    thisCallback2.callCounter = 0;
    thisCallback2.expectedValue.data = "is a value";
    thisCallback2.expectedValue.length = 10;
    TEST_ASSERT_EQUAL(LE_OK, appendHttpHeaderQueryRequest(&request, "This", (httpHeaderQueryExecutionHandler) fakeExecute, &thisCallback2));
