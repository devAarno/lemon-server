...
static void test_correctValues2(void) {
    ...
    TEST_ASSERT_EQUAL(LE_OK, appendHttpGetParameterQueryRequest(&request, "a", (httpGetParameterQueryExecutionHandler) fakeExecute, &aCallback1));

    sixtyCallback1.callCounter = 0;
    sixtyCallback1.expectedValue.data = "%63";
    sixtyCallback1.expectedValue.length = 3;
    TEST_ASSERT_EQUAL(LE_OK, appendHttpHeaderQueryRequest(&request, "%60", (httpHeaderQueryExecutionHandler) fakeExecute, &sixtyCallback1));
...
static void test_correctValues3(void) {
    ...
    TEST_ASSERT_EQUAL(LE_OK, appendHttpHeaderQueryRequest(&request, "%6", (httpHeaderQueryExecutionHandler) fakeExecute, &sixtyCallback1));
...
static void test_correctValues4(void) {
    ...
    sixtyCallback1.expectedValue.length = 3;
    TEST_ASSERT_EQUAL(LE_OK, appendHttpHeaderQueryRequest(&request, "%6z", (httpHeaderQueryExecutionHandler) fakeExecute, &sixtyCallback1));
